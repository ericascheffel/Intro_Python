...
list_chave =[chr(letra) for letra in range(ord('a'), ord('z')+1)]
print(list_chave)

list_valor =[chr(letra+2) for letra in range(ord('a'), ord('z')+1)] # gera o alfabeto
list_valor.remove("|")
list_valor.remove("{")
list_valor.extend("a")
list_valor.extend("b")
...
#teste = [chr(letra) for letra in range(ord('a'),ord('z')+2)]
#print(teste)
